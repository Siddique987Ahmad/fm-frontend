                ...
                {selectedCategory.id === "labour" && formData.categorySpecific.advanceAmount && (
                  <div>
                    ...
                    <input
                      type="number"
                      value={
                        employeeAdvances?.summary?.remainingSalary !== undefined 
                          ? (employeeAdvances.summary.remainingSalary - (parseFloat(formData.categorySpecific.advanceAmount) || 0))
                          : (formData.categorySpecific.remainingAmount || "0")
                      }
