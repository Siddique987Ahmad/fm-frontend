    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-100">
        <div className="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
          ...
          <button onClick={() => navigate('/login')} className="ml-4 text-blue-700 hover:underline">
            Go to Login
          </button>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-gray-100 flex">
      ...
      <aside className="w-64 bg-white shadow-lg flex flex-col">
        <div className="p-6 border-b border-gray-200">
          <h1 className="text-2xl font-bold text-gray-800">Factory Management</h1>
        ...
        <nav className="flex-1 p-6 space-y-2">
          <button
            ...
            className={`w-full text-left py-3 px-4 rounded-lg transition-colors duration-200 ${
              activeTab === 'dashboard' ? 'bg-blue-600 text-white' : 'hover:bg-gray-100 text-gray-700'
            }`}
          >
          ...
          <button
            ...
            className={`w-full text-left py-3 px-4 rounded-lg transition-colors duration-200 ${
              activeTab === 'transactions' ? 'bg-blue-600 text-white' : 'hover:bg-gray-100 text-gray-700'
            }`}
          >
            <div className="flex items-center">
              <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <button
            ...
            className={`w-full text-left py-3 px-4 rounded-lg transition-colors duration-200 ${
              activeTab === 'expenses' ? 'bg-blue-600 text-white' : 'hover:bg-gray-100 text-gray-700'
            }`}
          >
            <div className="flex items-center">
              <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <button
            ...
            className={`w-full text-left py-3 px-4 rounded-lg transition-colors duration-200 ${
              activeTab === 'reports' ? 'bg-blue-600 text-white' : 'hover:bg-gray-100 text-gray-700'
            }`}
          >
            <div className="flex items-center">
              <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <main className="flex-1 p-8">
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="ml-5 w-0 flex-1">
                      <dl>
                        ...
                        <dd className="text-lg font-medium text-gray-900">{stats.salesCount}</dd>
                      </dl>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="ml-5 w-0 flex-1">
                      <dl>
                        ...
                        <dd className="text-lg font-medium text-gray-900">{stats.purchaseCount}</dd>
                      </dl>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <div className="ml-5 w-0 flex-1">
                      <dl>
                        ...
                        <dd className="text-lg font-medium text-gray-900">PKR{stats.totalValue.toLocaleString()}</dd>
                      </dl>
                    </div>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                >
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-sm text-gray-500">Record sale or purchase</p>
                  </div>
                </button>
                ...
                >
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-sm text-gray-500">Record business expense</p>
                  </div>
                </button>
        ...
        {activeTab === 'transactions' && (
          <div className="bg-white shadow rounded-lg p-6">
            <h3 className="text-lg font-medium text-gray-900 mb-4">Transaction Management</h3>
        ...
        {activeTab === 'expenses' && (
          <div className="bg-white shadow rounded-lg p-6">
            <h3 className="text-lg font-medium text-gray-900 mb-4">Expense Management</h3>
            <p className="text-gray-600">Expense management features will be available here.</p>
            <div className="mt-4">
        ...
        {activeTab === 'reports' && (
          <div className="bg-white shadow rounded-lg p-6">
            ...
            <p className="text-gray-600">Reporting features will be available here.</p>
            <div className="mt-4">
